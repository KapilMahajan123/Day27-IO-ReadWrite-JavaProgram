...
public class WatchDirectory {
    public static void main(String[] args) {
        ...
        Path path = Paths.get("C:/Users/mahaj/Documents/TerminalCommands/linux-content");
        ...
        try (WatchService watchService = FileSystems.getDefault().newWatchService()) {
            ...
            Path logFilePath = Paths.get("C:/Users/mahaj/Desktop/229/Day27-IO-JavaProgram/src/com/IOprogram/logs.txt");
